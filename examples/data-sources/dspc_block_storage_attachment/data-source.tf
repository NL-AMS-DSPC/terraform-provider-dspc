data "asc_block_storage_attachment" "example" {
...
output "block_attachment_id" {
  ...
  value       = data.asc_block_storage_attachment.example.id
}

output "block_attachment_name" {
  description = "The ID of the requested block attachment"
  value       = data.asc_block_storage_attachment.example.block_storage_name
}

output "block_attachment_vm_name" {
  description = "The virtual machine name of the requested block attachment"
  value       = data.asc_block_storage_attachment.example.vm_name
}