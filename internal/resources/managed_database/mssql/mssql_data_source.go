// Package mssql implements the Terraform resource and data source for managing Microsoft SQL Server instances in the ASC platform.
package mssql
...
// DataSource implements the Terraform data source for retrieving MSSQL instance information from the ASC platform.
...
func (s *DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Retrieves a MSSQL instance in the ASC platform.",
